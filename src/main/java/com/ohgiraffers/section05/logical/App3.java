...
public class App3 {
    ...
    public static void main(String[] args) {
        ...
        *   뒤의 조건을 확인할 필요없이 false를 반환.
        *   따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이
        *   높은 편을 작성하는 것이 좋다.
        *  */
        ...
        /* 목차. 2. 논리식 || 논리식 : 앞의 결과가 true 이면 뒤를 실행 안 함 */
        /* 필기.
        *   조건식 둘 중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에서 미리 true가 나오게 되면
        *   뒤의 조건을 확인 할 필요 없이 true를 반환한다.
        *   따라서 연산 횟수를 줄이기 위해서는 || 연산의 경우 앞에 true가 나올 가능성이
        *   높은 편을 작성하는 것이 좋다.
        *  */
